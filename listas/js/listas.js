...
function add(list,elem){
    ...
    var tam = 0; //Declaramos una variable tamaño inicializada a 0
 	...
 	if (!isFull(list)){ //Comprobamos si la lista no esta llena
        list[size(list)] = elem; //La lista en cada posición donde se encuentre sera igual a elem.
        tam = size(list); //Le asignamos a la variable tam la función que devuelve el número de elementos de la lista
 	} else {
...
function addAt(list,elem,index){
    ...
    list[index-1] = num; //Se le asigna el número que vamos añadir a la variable num
...
function testList(){
    ...
    console.log("El elemento indicado en la posición 5 para eliminar es: "+remove(list,5));
    console.log(toString(list));

    console.log("El elemento 28 es el indicado para eliminar: "+removeElement(list,28));
    console.log(toString(list));

    console.log("El elemento a reemplazar indicado por el indice 3: "+set(list,82,3));
    console.log(toString(list));
    
    console.log("El elemento indicado para reemplazar en el indice 1: "+set(list,58,1));
    console.log(toString(list));

    console.log("El tamaño de la lista después de añadir el elemento 22 en la posición 1 es de: "+addAt(list,22,1));
    console.log(toString(list));

    console.log("El elemento 82 indicado para eliminar ¿Ha sido eliminado?: "+removeElement(list,82));
    console.log(toString(list));

    console.log("El tamaño de la lista después de añadir el elemento 9 en la posición 1 es de "+addAt(list,9,1));
    console.log(toString(list));

    console.log("El tamaño de la lista después de añadir el elemento 28 en la posición 2 es de "+addAt(list,28,2));
    console.log(toString(list));

    console.log("El tamaño de la lista después de añadir el elemento 36 en la posición 3 es de "+addAt(list,36,3));
    console.log(toString(list));
}
